...
const Field = ({ fillColor, strokeColor, strokeWidth }) => (
  <Svg
    id='Layer_1'
  ...
  >
    {/* Outfield */}
    <Path
      fill={fillColor.outfield}
      stroke={strokeColor.outfield}
      strokeWidth={strokeWidth.outfield}
      className='st0'
    ...
    {/* Infield Dirt */}
    <Path
      fill={fillColor.infieldDirt}
      stroke={strokeColor.infieldDirt}
      strokeWidth={strokeWidth.infieldDirt}
      className='st0'
    ...
    <Path
      fill={fillColor.home}
      stroke={strokeColor.home}
      strokeWidth={strokeWidth.home}
      className='st0'
    ...
    {/* Infield Grass */}
    <Path
      fill={fillColor.infieldGrass}
      stroke={strokeColor.infieldGrass}
      strokeWidth={strokeWidth.infieldGrass}
      className='st0'
    ...
    {/* 1st Base */}
    <Path
      fill={fillColor.bases}
      stroke={strokeColor.bases}
      strokeWidth={strokeWidth.bases}
      className='st0'
    ...
    {/* Mound */}
    <Path
      fill={fillColor.mound}
      stroke={strokeColor.mound}
      strokeWidth={strokeWidth.mound}
      className='st0'
    ...
    <Path
      ...
      fill={fillColor.rubber}
      stroke={strokeColor.rubber}
      strokeWidth={strokeWidth.rubber}
    />
  </Svg>
);
